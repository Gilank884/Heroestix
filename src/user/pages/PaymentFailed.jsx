        ...
        <div className="bg-[#fbffff] min-h-screen font-sans text-slate-900 flex flex-col">
            ...
            <div className="flex-grow flex items-center justify-center pt-32 pb-20 px-4">
                <div className="max-w-md w-full bg-white rounded-3xl p-8 text-center shadow-xl border border-slate-100">
                    ...
                    <h2 className="text-3xl font-black text-slate-800 mb-2">Pembayaran Gagal</h2>
                    <p className="text-slate-500 mb-8 font-medium">Maaf, pembayaran Anda untuk pesanan <span className="font-bold text-slate-700">#{id?.substring(0, 8).toUpperCase()}</span> gagal atau telah dibatalkan.</p>
