...
const Daftar = ({ role = "user" }) => {
    ...
    const handleEmailRegister = async (e) => {
        ...
        if (error) {
            ...
            if (profileError) console.error("Error creating/updating profile:", profileError.message);
            ...
            if (role === 'creator') {
                ...
                if (creatorError) console.error("Error creating creator profile:", creatorError.message);
            }
                ...
                <div className="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm">
                    ...
                    <div className="p-8 md:p-10 text-center border-b border-slate-50">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-50 text-blue-600 rounded-lg text-[10px] font-black uppercase tracking-widest mb-6">
                            ...
                            {isCreator ? "CREATOR REGISTRATION" : "USER REGISTRATION"}
                        </div>
                        <h1 className="text-2xl font-black text-slate-900 tracking-tight">
                            {isCreator ? "Mulai Kelola Event" : "Gabung Heroestix"}
                        </h1>
